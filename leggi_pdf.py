...
class Coa:
    ...
    def recappone(cls):
        ...
        if hash_aggiunta not in df_log['batch_id'].values:
            ...
            print("Bollettone aggiornato correttamente.")
        else:
            print("Dati già precedentemente inseriti nel bollettone, nessuna modifica.")
        return cls.df_recap
    ...
    def processa(self):
        ...
        self.batch_compresso = self.batch.replace(' / IT01 ', '')[4:]
        ...
        for analisi in self.istanza_prodotto.lista_analisi:
            ...
            try:
                testo = risultati[0]
                rettangolo_valore = pymupdf.Rect(x0=testo.x0+260, y0=testo.y0, x1=testo.x1+350, y1=testo.y1)
