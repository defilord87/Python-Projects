...
lista_prodotti = ['D3336C', 'P6072C', 'P6097C', 'P6059C', 'P6571C', 'P6052C', 'P6660C', 'P5245C', 'D3502C', 'D3474C']
...
prodotti = [
    ...
    Prodotto('P6059C', 'salicilato', riga=73, analisi=(0, 6, 7, 3, 2, 14, 13, 16, 17, 12, 10, 1, 15, 9, 18)),
